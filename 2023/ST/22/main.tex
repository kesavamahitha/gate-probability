...
\begin{enumerate}
\item \label{eq:22/2023/ST/3}$\sqrt{\frac{\bar{Y}}{2}} \text{is a method of moments estimator of}         \lambda$
...
\solution\\
\begin{enumerate}
\item Using PDF in \eqref{eq:22/2023/ST/1} we need to find an estimator for the unknown parameter $\lambda$ in terms of sample mean $\bar{Y}$\\
we know $Y_i=X_i^2$
then,
\begin{align}
E(Y_i)&=E(X_i^2)\\
...
&= 2{\lambda}^2
\end{align} 
Method of moment is defined by \eqref{eq:22/2023/ST/2} which gives,
\begin{align}
\bar{Y} & = E(Y_i)\\
&= 2{\lambda}^2
\end{align} 
...
\end{align}
$\therefore$ Option \eqref{eq:22/2023/ST/3} is correct.
...
\begin{figure}[ht]
    ...
    \caption{Figure1}
	\label{Fig:2023/ST/22/figs/Figure1}
\end{figure}
