...
\\
\solution
\input{variable/solutions/6.tex}

\item Let $X$ and $Y$ be continuous random variables with joint probability density function 
\begin{equation*}
...
%
\solution
\input{variable/solutions/5.tex}


\item A fair die is rolled twice independently. Let X and Y denote the outcomes of the first and second roll, respectively. Then $E(X+Y\:|\:(X-Y)^2=1)$ equals
\\
\solution
\input{variable/solutions/4/Assignment-4.tex}
...
\\
\solution
\input{variable/solutions/3/Assignment2.tex}


\item $p_{X}\brak{x}=Me^{-2\abs{x}}+Ne^{-3\abs{x}}$ is the probability density function for the real random variable $X$, Over the entire $x$ axis. $M$ and $N$ are both positive real numbers. Find The equation relating $M$ and $N$
\\
\solution
\input{variable/solutions/2.tex}

\item The probability density function(PDF) of a random variable X is as shown in Fig. \ref{fig:var/solutions/1/PDF Graph}.
...
\caption{PDF Graph}
\label{fig:var/solutions/1/PDF Graph}
\end{figure}
%
\\
\solution
\input{variable/solutions/1/assignment2.tex}
...
%
\solution
\input{solutions/adv/ma/2016/30/Assignment4.tex}
...
%
\solution
\input{solutions/adv/ma/2012/8.tex}
...
\item    Let the probability density function of a random variable X be
   ...
   \\
\solution
\input{solutions/adv/ma/2016/10/Assignment5.tex}
...
\\
  \solution
  \input{solutions/adv/ma/2015/9/ASSIGNMENT_5.tex}
...
\\
\solution
\input{solutions/adv/ma/2018/23/main.tex}
...
\\
\solution
\input{solutions/adv/ma/2017/46/Assignment-5.tex}
%
...
\\
\solution
\input{solutions/adv/st/2019/45.tex}
%
...
\end{enumerate}
  \solution
  \input{solutions/adv/ma/2012/29.tex}
...
%
\solution
\input{solutions/adv/ma/2018/24/main.tex}
%
...
\\
\solution
  \input{solutions/adv/ma/2015/27/latex4.tex}
  ...
  \solution
    \input{solutions/adv/st/2021/22.tex}
%
...
%
  \solution 
  \input{solutions/adv/st/2019/43/Assignment5.tex}
