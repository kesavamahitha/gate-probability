...
\item strictly positive \label{ec44:option A}
\item zero \label{ec44:option B}
\item strictly negative \label{ec44:option C}
\item strictly positive, zero or strictly negative depending on the nonzero value of $\sigma ^2$ \label{ec44:option D}
\end{multicols}
\end{enumerate}
%
\solution
\input{solutions/ec/44/Assignment3.tex}
...
\\
\solution
\input{solutions/ec/52/assignment2.tex}
...
\\
\solution
\input{solutions/ec/54/Assignment_2.tex}
...
Then $P\brak{2 \leq\ X<4}$ is equal to \underline{\hspace{3cm}}
 \\
\solution
\input{solutions/ec/58/Assignment2.tex}
...
\end{cases}
$ \\
Then $P  \brak{ \frac{1}{2} } $ is equal to.......
\\
\solution
\input{solutions/ec/72/Assignment_2_AI1103.tex}
...
%
\solution
\input{solutions/xe/2020/14.tex}
%
...
\end{enumerate}
\solution
\input{solutions/ee/2014/27.tex}
%
...
Then \pr{X > 1} is ?
\solution
\input{solutions/ee/2013/11.tex}
%
...
\\
\solution
\input{solutions/me/2020/36.tex}
%
...
%
\solution
\input{solutions/in/2007/27.tex}
%
...
%
\solution
\input{solutions/me/2005/38.tex}
%
...
%
\solution
\input{solutions/me/2018/18.tex}
%
...
%
\solution
\input{solutions/ec/2003/61.tex}
%
...
%
\solution
\input{solutions/ec/2001/1.20.tex}
%
...
%
%\solution
%\input{solutions/ec/2021/27.tex}
%
...
%
\item A batch of one hundred bulbs is inspected by testing four randomly chosen bulbs. The batch is rejected if even one of the bulbs is defective. A batch typically has five defective bulbs. The probability that the current batch is accepted is ---. \\
%
\solution
\input{solutions/me/2014/10.tex}
%
\item A box contains following three coins.
 \begin{enumerate}[label=\Roman*.]
...
%
\solution
\input{solutions/cs/2018/15.tex}
%
\item A continuous random variable X has a probability density function $f\brak{x}=e^{-x}$, $0<x<\infty$, then  $\pr{X>1}$ is
%
\solution
\input{solutions/in/2013/16.tex}
%
\item If two fair coins are flipped and atleast one of the outcomes is known to be a head, what is the probability that both outcomes are heads ?
    ...
    %
\solution
\input{solutions/cs/2011/3.tex}
%
\item If 20 percent of managers are technocrats , the probability that a random committee of 5 managers consists of exactly 2 technocrats is: 
\begin{enumerate}
    \item 0.2048
    \item 0.4000
    \item 0.4096
...
\end{enumerate}
    %
\solution
\input{solutions/me/1993/7.1.tex}
%
%
\item Four fair coins are tossed simultaneously. The probability that at least one head and one tail turn up is
\begin{enumerate}[label=\alph*)]
    \item $\frac{1}{16}$\\
    \item $\frac{1}{8}$\\
    \item $\frac{7}{8}$\\
...
\end{enumerate}
    %
\solution
\input{solutions/cs/2002/41.tex}
%
\item Given set A = \{2,3,4,5\} and set B = \{11,12,13,14,15\}, two numbers are randomly selected , one from each set. What is the probability that sum of two numbers is equal to 16?
    %
\solution
\input{solutions/cs/2015/3/assignment4.tex}
